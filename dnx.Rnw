...
\vspace{-.65cm}
\captionof{figure}{Aposteriorna gostota in ocene parametri za dolžine palčk v prvi vrečki.}
\label{fig1}
\vspace{.3cm}
\includegraphics[width = \linewidth]{./dnx-FIG2}
\vspace{-.65cm}
\captionof{figure}{Aposteriorna gostota in ocene parametri za dolžine palčk v drugi vrečki.}
\label{fig2}
\vspace{.3cm}
...
\vspace{-.65cm}
\captionof{figure}{Aposteriorna gostota in ocene parametri za dolžine palčk v tretji vrečki (spuščena iz $4\text{m}$).}
\label{fig3}
\vspace{.3cm}
\includegraphics[width = \linewidth]{./dnx-FIG4}
\vspace{-.65cm}
\captionof{figure}{Aposteriorna gostota in ocene parametri za dolžine palčk v četrti vrečki (spuščena iz $4\text{m}$).}
\label{fig4}
\vspace{.3cm}
\end{minipage}
