...
Model izračuna pričakovano število palčk za cele vrečke $121.4$, standardni odklon $\sigma =121.5$ in napako $err _{mcmc} = \pm 1.3$. Za spuščene vrečke dobimo vrednosti $\mu = 303.7$, $\sigma = 132.6$ in napako $err _{mcmc} = \pm 6.1$.
